...
export default function LinkedInJobListItem({
  ...
  return (
    ...
    >
      ...
      <div
        className={`job-prose text-gruvbox-fg2 mb-4 [&_a]:text-gruvbox-orange_light [&_a:hover]:text-gruvbox-orange_light [&_a]:underline [&_a]:font-medium whitespace-pre-wrap ${
          showDetails
