  ...
  return (
    <div className="min-h-screen bg-gruvbox-bg transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-8 md:pt-12 pb-4">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-2 border-b border-gruvbox-bg3 pb-6">
          <div className="text-center lg:text-left">
            ...
            <p className="text-gruvbox-fg3 text-base sm:text-lg max-w-2xl leading-relaxed">
              The ultimate aggregator for high-signal tech opportunities. Parsed
              with AI, delivered to you.
            </p>
          </div>
